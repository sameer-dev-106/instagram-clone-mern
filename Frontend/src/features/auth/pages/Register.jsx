    ...
    <main className={styles.authPage}>
      ...
      <div className={styles.leftPanel}>
        ...
        <div className={styles.leftHeadline}>
          <h2>
            Your creativity<br />
            deserves a <span>stage.</span>
          </h2>
          <p>
            Start sharing, connecting, and growing with a community that
            celebrates visual storytelling.
          </p>
        </div>
        ...
        <div className={styles.leftFeatures}>
          <div className={styles.feature}>
            ...
            <div className={styles.featureText}>
              ...
              <p>Create your profile and start posting immediately</p>
            </div>
          </div>
          <div className={styles.feature}>
            <span className={styles.featureIcon}>💜</span>
            <div className={styles.featureText}>
              ...
              <p>Get likes, comments, and real engagement</p>
            </div>
          </div>
          <div className={styles.feature}>
            <span className={styles.featureIcon}>🔒</span>
